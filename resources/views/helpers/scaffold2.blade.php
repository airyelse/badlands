        ...
        <form method="post" action="{{$action}}" id="scaffold" pjax-container>
            ...
            <table class="table table-hover responsive table-header-gray " id="table-fields" style="margin-top:25px;">
                ...
                <tr>
                    ...
                    <th>{{trans('admin.scaffold.field')}}</th>
                    <th>{{trans('admin.scaffold.form.type')}}</th>
                    <th>{{trans('admin.scaffold.gird.type')}}</th>
                    <th>{{trans('admin.scaffold.view.type')}}</th>
...
<template id="table-field-tpl">
    <tr>
        ...
        <td>
            <select style="width: 200px" name="fields[__index__][field]">
                @foreach(Dcat\Admin\Form::extensions() as $key=> $type)
        ...
        <td>
            <div class="vs-checkbox-con vs-checkbox-primary">
                <input name="fields[__index__][grid]" type="checkbox"/>
                <span class="vs-checkbox vs-checkbox-">
                  <span class="vs-checkbox--check">
                    <i class="vs-icon feather icon-check"></i>
                  </span>
        ...
        <td>
            <div class="vs-checkbox-con vs-checkbox-primary">
                <input name="fields[__index__][view]" type="checkbox"/>
                <span class="vs-checkbox vs-checkbox-">
                  <span class="vs-checkbox--check">
                    <i class="vs-icon feather icon-check"></i>
                  </span>
